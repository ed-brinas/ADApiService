...
public class AdService : IAdService
{
    ...
    public async Task<IEnumerable<UserListItem>> ListUsersAsync(string domain, string? nameFilter, bool? statusFilter)
    {
        return await Task.Run(() =>
        {
            ...
            // FIX: Added the missing 'domain' argument to this logging statement.
            _logger.LogInformation("Found {Count} relevant OUs to search for domain '{Domain}': {RelevantOus}", relevantOus.Count, domain, string.Join("; ", relevantOus));
